      ...
      <div ref={container} className="bg-default dark:bg-muted relative isolate flex flex-auto flex-col">
        <div
          ...
          <div className="relative flex flex-auto overflow-x-auto">
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1 [--disabled-gradient-background:#F8F9FB] [--disabled-gradient-foreground:#E6E7EB] dark:[--disabled-gradient-background:#262626] dark:[--disabled-gradient-foreground:#393939]">
              <HorizontalLines
                startHour={startHour}
                endHour={endHour}
